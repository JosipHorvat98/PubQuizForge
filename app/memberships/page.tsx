    ...
    <main className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <section className="section-space">
        <div className="container-shell">
          ...
          <div className="mt-6 inline-flex rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-[var(--muted)]">
            Packs can be bought as a guest. Memberships require an account.
          </div>
        </div>
      </section>
            ...
            return (
              ...
              >
                <div className="absolute right-5 top-5 flex gap-2">
                  <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.2em] text-white">
                    Account Required
                  </span>

                  {plan.featured ? (
                    <span className="rounded-full bg-[var(--gold)] px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.2em] text-black">
                      Most Popular
                    </span>
                  ) : null}
                </div>
